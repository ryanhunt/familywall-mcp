...
Status: all tasks below are **not started**. Planning and AI repository setup are
complete; no runtime task is complete. Update this file with task status, commit/PR
and acceptance evidence as work lands. See [phase plan](implementation-plan.md).
...
| 01A | Package/config/model foundation | 00A, 00C | Luna |
| 01B | Offline harness and CI | 01A | Luna |
